...
let header = {
    ...
    const AdminLogin = (e) => {
        ...
        axios.post(rest.AdminLogin, data, header)
            .then(response => {
            ...
            <div class="card w-30 m-auto p-5">
                <div class="text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
                     ...
                     <p class="mt-2">Access the administration Portal</p>
                </div>
               <form onSubmit={AdminLogin} method="post">
                <div class="form-group mt-5">
                    <label class="form-control-label" htmlFor="Email">Email Address</label>
                    <input  class="form-control" type="email" name="Email" id="Email" placeholder="Enter your email" required onKeyUp={validateEmail}/>
                    <p className="error ">{emailError}</p>
                </div>
                 <div class="form-group mt-5">
                    <label class="form-control-label" htmlFor="Password">Password</label>
                    <input  class="form-control" type="password" name="password" id="Password" placeholder="Enter your Password" required onKeyUp={validatePassword}/>
